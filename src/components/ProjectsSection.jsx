      ...
      <div className="projects__content">
        ...
        <div className='projects__menu'>
          <ul className='projects__list'>
            <li><a className='projects__link' href="">Todos</a></li>
            <li><a className='projects__link' href="">Ecommerse</a></li>
            <li><a className='projects__link' href="">Muebleria</a></li>
            <li><a className='projects__link' href="">Divulgación</a></li>
            <li><a className='projects__link' href="">TikTakToe</a></li>
          </ul>
        </div>
        */}
        ...
        <div className='projects__box'>
          ...
          <div className='project__card'>
            ...
            <a className='project__btn' target='_blank' href="https://github.com/Grabyte/UTN_Professional_Front_End_Developer/tree/main/Proyecto_CodeInfoWeb">Visitar codigo</a>
          </div>
          <div className='project__card'>
            ...
            <a className='project__btn' target='_blank' href="https://github.com/Grabyte/UTN_Full_Stack_Developer/tree/main/React_Practicas/proyecto_3_en_ralla">Visitar codigo</a>
          </div>
          <div className='project__card'>
            ...
            <a className='project__btn' target='_blank' href="https://github.com/Grabyte/UTN_Professional_Front_End_Developer/tree/main/Proyecto_Muebleria">Visitar codigo</a>
          </div>
        </div>
      </div>
    </section>
